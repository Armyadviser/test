...
public class FileReader implements Closeable {
	...
	private boolean open(String strFilePath, String encoding) {
		mLineNum = 0;
	...
	public static Stream<String> mapForEach(String filePath, String encode) {
		return forEachWithProcessor(filePath, encode, DEFAULT_PROCESSOR);
	}
